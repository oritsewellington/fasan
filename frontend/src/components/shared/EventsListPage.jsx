 ...
 * EventsListPage
 * -----------------------------------------------------------------------
 * Shared by both /admin/events and /organizer/events. There's no more
 * per-user ownership of events — any staff or admin account can manage
 * any event — so there's nothing left to differentiate the two views
 * beyond the base path used for links.
 */
