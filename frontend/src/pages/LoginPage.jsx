    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 bg-gray-50 animate-fade-in">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Login to your admin or organizer dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card p-6 space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input type="email" required value={email} onChange={e => setEmail(e.target.value)} className="input-field pl-10" placeholder="you@fasaawards.site" />
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              ...
              <input type={showPw ? 'text' : 'password'} required value={password} onChange={e => setPassword(e.target.value)} className="input-field pl-10 pr-10" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" />
        ...
        <div className="mt-6 card p-4 bg-gold-50 border-gold-100">
          <p className="text-xs font-semibold text-gold-800 mb-1.5">Demo credentials</p>
          <p className="text-xs text-gold-700">Admin: admin@fasaawards.site / Admin@1234</p>
          <p className="text-xs text-gold-700">Organizer: organizer@fasaawards.site / Organizer@1234</p>
        </div>
      </div>
    </div>
  );
